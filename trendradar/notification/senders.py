    ...
    *,
    ...
    for i, batch_content in enumerate(batches, 1):
        ...
        payload = {
            "msgtype": "markdown",
            "markdown": {
                "title": f"Odin-Assistant 热点分析报告 - {report_type}",
                "text": batch_content,
            },
        }
...
def send_to_email(
    ...
    *,
    ...
    try:
        ...
        subject = f"Odin-Assistant 热点分析报告 - {report_type} - {now.strftime('%m月%d日 %H:%M')}"
