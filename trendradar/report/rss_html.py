        ...
        <script>
            async function saveAsImage() {
                ...
                try {
                    ...
                    const now = new Date();
                    const filename = `Odin-Assistant_RSS订阅_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}.png`;
