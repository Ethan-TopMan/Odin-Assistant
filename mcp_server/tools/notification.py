...
<html><head><meta charset="utf-8"><title>Odin-Assistant 通知</title>
...
def _send_email(
    ...
    try:
        ...
        msg["From"] = formataddr(("Odin-Assistant", from_email))
...
def _send_ntfy(server_url: str, topic: str, content: str, title: str, token: str = "") -> Dict:
    ...
    headers = {
        ...
        "Markdown": "yes",
        "Title": "Odin-Assistant Notification",  # ASCII，避免 HTTP header 编码问题
        "Priority": "default",
        "Tags": "news",
    }
    if token:
