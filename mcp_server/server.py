"""
Odin-Assistant MCP Server - FastMCP 2.0 实现
...
async def get_platforms_resource() -> str:
    ...
    return json.dumps({
        ...
        "description": "Odin-Assistant 支持的热榜平台列表"
...
async def get_rss_feeds_resource() -> str:
    ...
    return json.dumps({
        ...
        "description": "Odin-Assistant 支持的 RSS 订阅源列表"
    }, ensure_ascii=False, indent=2)
...
async def get_keywords_resource() -> str:
    ...
    return json.dumps({
        ...
        "description": "Odin-Assistant 关注词配置"
    }, ensure_ascii=False, indent=2)
...
async def check_version(
    ...
    """
    检查版本更新（同时检查 Odin-Assistant 和 MCP Server）
...
async def send_notification(
    ...
    Args:
        ...
        title: 消息标题，默认 "Odin-Assistant 通知"
...
def run_server(
    ...
    print()
    print("=" * 60)
    print("  Odin-Assistant MCP Server - FastMCP 2.0")
    print("=" * 60)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Odin-Assistant MCP Server - 新闻热点聚合 MCP 工具服务器',
